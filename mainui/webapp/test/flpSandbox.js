		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Upload Surcharge",
									"targetURL": "#comzgaurfiorimainui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comzgaurfiorimainui-display": {
								"semanticObject": "comzgaurfiorimainui",
								"action": "display",
								"description": "Upload Surcharge",
								"title": "Upload Surcharge",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.zgaur.fiori.mainui",
									"url": sap.ui.require.toUrl("com/zgaur/fiori/mainui")
								}
							}
						}
					}
