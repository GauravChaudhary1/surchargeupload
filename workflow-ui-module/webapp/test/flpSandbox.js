		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Surcharge Approval",
									"targetURL": "#comzgaurfioriworkflowuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comzgaurfioriworkflowuimodule-display": {
								"semanticObject": "comzgaurfioriworkflowuimodule",
								"action": "display",
								"description": "Surcharge Approval",
								"title": "Surcharge Approval",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.zgaur.fiori.workflowuimodule",
									"url": sap.ui.require.toUrl("com/zgaur/fiori/workflowuimodule")
								}
							}
						}
					}
